...
public class ViewJobs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (currentUser == null) {
            Intent loginIntent = new Intent(ViewJobs.this, Register.class);
            ...
            protected void onBindViewHolder(@NonNull AtticViewHolder holder, int position, @NonNull Attic model) {
                ...
                holder.post_layout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent singleActivity = new Intent(ViewJobs.this, SinglePostActivity.class);
                ...
                holder.likePostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (user != null) {
                            ...
                            Toast.makeText(ViewJobs.this, "Please Login", Toast.LENGTH_SHORT).show();
                        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            mAuth.signOut();
            Intent logouIntent = new Intent(ViewJobs.this, Register.class);
